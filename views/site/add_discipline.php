<div style="display: flex; flex-direction: column; align-items: center">
    ...
    <form method="POST">
        ...
        <input type="text" name="title_discipline" required placeholder="Название" style="width: 900px; height: 60px; background-color: #F1F1F1; border: none; border-radius: 10px">
