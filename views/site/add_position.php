<div style="display: flex; flex-direction: column; align-items: center">
    ...
    <input type="text" name="title_position" required placeholder="Название" style="width: 900px; height: 60px; background-color: #F1F1F1; border: none; border-radius: 10px">
